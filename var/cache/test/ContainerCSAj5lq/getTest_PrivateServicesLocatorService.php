...
class getTest_PrivateServicesLocatorService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Application\\FizzBuzz\\GenerateFizzBuzzSequence' => ['privates', 'App\\Application\\FizzBuzz\\GenerateFizzBuzzSequence', 'getGenerateFizzBuzzSequenceService', true],
            'App\\Domain\\FizzBuzz\\FizzBuzzRepository' => ['privates', 'App\\Infrastructure\\Persistence\\Doctrine\\FizzBuzz\\DoctrineOrmFizzBuzzRepository', 'getDoctrineOrmFizzBuzzRepositoryService', true],
            'App\\Domain\\FizzBuzz\\Listener\\GenerateLogWhenFizzBuzzWasCreated' => ['privates', 'App\\Domain\\FizzBuzz\\Listener\\GenerateLogWhenFizzBuzzWasCreated', 'getGenerateLogWhenFizzBuzzWasCreatedService', true],
            'App\\Domain\\Shared\\Messenger\\MessengerBusInterface' => ['privates', 'App\\Infrastructure\\Bus\\Messenger\\MessengerBusSymfony', 'getMessengerBusSymfonyService', true],
            'App\\Infrastructure\\Bus\\Messenger\\MessengerBusSymfony' => ['privates', 'App\\Infrastructure\\Bus\\Messenger\\MessengerBusSymfony', 'getMessengerBusSymfonyService', true],
            'App\\Infrastructure\\Persistence\\Doctrine\\FizzBuzz\\DoctrineOrmFizzBuzzRepository' => ['privates', 'App\\Infrastructure\\Persistence\\Doctrine\\FizzBuzz\\DoctrineOrmFizzBuzzRepository', 'getDoctrineOrmFizzBuzzRepositoryService', true],
            ...
            'App\\UI\\Http\\Web\\Forms\\FizzBuzzForm' => ['privates', 'App\\UI\\Http\\Web\\Forms\\FizzBuzzForm', 'getFizzBuzzFormService', true],
            ...
            'App\\Application\\FizzBuzz\\GenerateFizzBuzzSequence' => '?',
            'App\\Domain\\FizzBuzz\\FizzBuzzRepository' => '?',
            'App\\Domain\\FizzBuzz\\Listener\\GenerateLogWhenFizzBuzzWasCreated' => '?',
            'App\\Domain\\Shared\\Messenger\\MessengerBusInterface' => '?',
            'App\\Infrastructure\\Bus\\Messenger\\MessengerBusSymfony' => '?',
            'App\\Infrastructure\\Persistence\\Doctrine\\FizzBuzz\\DoctrineOrmFizzBuzzRepository' => '?',
            'App\\UI\\Http\\Web\\Forms\\BeginLessThanLastValidator' => '?',
            'App\\UI\\Http\\Web\\Forms\\FizzBuzzForm' => '?',
